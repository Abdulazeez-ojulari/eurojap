            ...
            <div id="con" class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-5">
                        <div class="thumbnail">
                            <a href="ruby2f.php">
                                <img src="../image/ruby2fblue.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Ruby 2F</h3>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-5">
                        <div class="thumbnail">
                            <h2>Features</h2>
                              <ul class="list-group">
                                <li class="list-group-item">Double door</li>
                                <li class="list-group-item">Fridge</li>
                                <li class="list-group-item">Water Collector</li>
                                <li class="list-group-item">Red, Silver, Blue</li>
                                <li class="list-group-item">Replaceable Pencil Puncture</li>
                              </ul>
                        </div>
